...
return [
    ...
    'image-naming-method' => 'unique-real-file-name',
    ...
    'audio-naming-method' => 'unique-real-file-name',
    ...
    'file-naming-method' => 'unique-real-file-name',
            ...
            'options' => [
                ...
                'image' => [
                    ...
                    'resizeOptions' => [
                        ...
                        ['name' => 'resizeImage:25', 'value' => '25', 'label' => 'Small (25%)', 'icon' => 'small'],
                        ['name' => 'resizeImage:50', 'value' => '50', 'label' => 'Medium', 'icon' => 'medium'],
                        ['name' => 'resizeImage:75', 'value' => '75', 'label' => 'Large (75%)', 'icon' => 'large']
                    ],
                    'toolbar' => [
                        'mediaBrowser',
                        '|',
